...
resource "aws_ecs_task_definition" "Django-API" {
  family                   = "Django-API-task"
  requires_compatibilities = ["FARGATE"]
  network_mode             = "awsvpc"
  
  # Veja tabela HW AWS -> https://docs.aws.amazon.com/pt_br/AmazonECS/latest/developerguide/task_definition_parameters.html
  cpu                      = 256
  memory                   = 512
...
[
  {
    "name"= "producao"
    "image"= "759410591479.dkr.ecr.us-east-1.amazonaws.com/producao:v1"
    "cpu"= 256
    "memory"= 512
    "essential"= true
    "portMappings" = [
